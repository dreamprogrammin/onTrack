...
import { isActivityValid, validateTimelineItems } from "@/components/validator.js"
...
const secondsDiff = computed(
 () =>
  getTotalActivitySeconds(props.activity, props.timelineItems) - props.activity.secondToComplete
)
</script>
